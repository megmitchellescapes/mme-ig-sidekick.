...
<div class="wrap">
  <header class="hero">
    <div class="kicker">Meghan Mitchell Escapes • Version 2.7</div>
  ...
  <section>
    <div class="section-head">
      <div><h2>Engagement Tracker</h2><p>Log what you actually did so Sidekick can keep the relationship history straight.</p></div>
    </div>
    <div class="card">
      <div class="mix">
...
function renderAll(){renderTabs();renderSaved();renderToday();renderStats();renderTagBank();renderEngagementTracker();renderEngagementStats()}
check();renderAll();
</script>
</body>
</html>
