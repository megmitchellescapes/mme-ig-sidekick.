...
<div class="wrap">
  <header class="hero">
    <div class="kicker">Meghan Mitchell Escapes • Version 2.9</div>
    ...
    return `<div class="checklist-item">
      ...
      <div class="checklist-text">
        ...
        ${acct?`<div class="checklist-account">${esc(acct.handle)} · ${esc(acct.bucket)}</div>
          ...
          <div class="actions"><a class="btn primary" target="_blank" href="${acct.url}">Open Instagram</a></div>`:""}
      </div>
    </div>`;
  }).join("");
...
function renderAll(){renderTabs();renderSaved();renderToday();renderStats();renderTagBank();renderDestinationTabs();renderEngagementTracker();renderEngagementStats();renderCalendar();renderDailyChecklist()}
check();renderAll();applyMajorCollapseState();
</script>
</body>
</html>
"""
